...
let Boton2 = document.getElementById("B12");
...
const canvasRamo = document.getElementById("FlorRamo");
...
function CrearVarias() {
  ...
  const TamañoFlor = Math.min(espacioX, espacioY) * 0.8; // Tamaño relativo al espacio disponible
